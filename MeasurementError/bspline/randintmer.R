randintmer = function(y, w, v, Z, n_intknot=10, prior=NULL, maxiter=500, tol=1e-3, n_grids=1e3, resolution=200)
{
  # Semiparametric Random Intercept model with measurement error using B-spline
